...
logging.basicConfig(level=logging.INFO, format='%(asctime)s - VerPoint AI - %(levelname)s - %(message)s')
...
class VerPointAI:
    ...
    def __init__(self, tavily_key: str = None, serper_key: str = None):
        ...
        # V40: Adversarial Contradiction Library
    ...
    def run_master_audit(self, response_text: str, evidence: List[Dict] = []):
        ...
        if conflicts: integrity_score *= 0.85 
...
# --- INITIALIZATION ---
master = VerPointAI()
print(f"Initialized: {master.brand} {master.version}")
